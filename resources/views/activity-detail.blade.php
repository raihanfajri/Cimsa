    ...
    <header class="header">
        <div class="jumbotron jumbotron-fluid parralax-activities">
            <div class="container text-center">
                <h1 class="display-3 img-animated-section2"><b>JUDUL AKTIFITAS</b></h1>
            </div>
        </div>
    </header>
        ...
        <div class="row">
            <div class="col-md-9">
                <section class="main-article">
                    <h2 class="page-title">JUDUL AKTIFITAS</h2>
            ...
            <div class="col-md-3">
                <section class="recent-post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img src="{{ asset('img/fk-andalas.jpg') }}" alt="article image" width="100%" height="90px">
                        </div>
                        <div class="col-md-6" style="margin-bottom: 30px;">
                            <a href="#">
                                <p style="font-size: 13px;"><b>JUDUL AKTIFITAS LAINNYA</b></p>
                            </a>
